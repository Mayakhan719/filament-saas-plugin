...
use Maya\FilamentSaasPlugin\Models\PaymentLog;
use Maya\FilamentSaasPlugin\Services\Contracts\PaymentCurrency;
use Maya\FilamentSaasPlugin\Services\Contracts\PaymentGateway;
...
class StripeV3 extends Driver
{
    ...
    {
        $StripeAcc = \Maya\FilamentSaasPlugin\Models\PaymentGateway::where('alias', 'StripeV3')->orderBy('id', 'desc')->firstOrFail();
